...
export async function sendNativePushToGame(gameId, { title, body, url, tag, filterColumn, excludePlayerId, aliveOnly }) {
  ...
  // Same scoped, opt-in aliveOnly as sendPushToGame in lib/sendPush.js
  // — see that function's own comment for why this is never the
  // default.
  if (aliveOnly) {
