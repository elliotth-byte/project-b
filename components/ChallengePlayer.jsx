...
import DivinersDicePlayer from "./games/DivinersDicePlayer";
import GodsAndGambitsPlayer from "./games/GodsAndGambitsPlayer";
import SplitFrictionPlayer from "./games/SplitFrictionPlayer";
import CrownsPlayer from "./games/CrownsPlayer";
import PoseidonsPoolPlayer from "./games/PoseidonsPoolPlayer";
import PoseidonsPoolTvPlayer from "./games/PoseidonsPoolTvPlayer";
import PythiasDicePlayer from "./games/PythiasDicePlayer";
import NaiadsAqueductPlayer from "./games/NaiadsAqueductPlayer";
import PansPanicPlayer from "./games/PansPanicPlayer";
import DelphisDigPlayer from "./games/DelphisDigPlayer";
import MidasHoardTvPlayer from "./games/MidasHoardTvPlayer";
import ChariotsPlayer from "./games/ChariotsPlayer";
import ScyllasStraitPlayer from "./games/ScyllasStraitPlayer";
...
export const FULLSCREEN_ELIGIBLE_GAMES = new Set([
  ...
  "mazetrivia", "wordscramble", "sandsoftime", "hue", "minigolf", "poseidonspool", "panspanic", "delphisdig",
]);
...
export const GAME_COMPONENTS = {
  ...
  divinersdice: DivinersDicePlayer,
  splitfriction: SplitFrictionPlayer,
  crowns: CrownsPlayer,
  crownstv: CrownsPlayer,
  poseidonspool: PoseidonsPoolPlayer,
  poseidonspooltv: PoseidonsPoolTvPlayer,
  pythiasdice: PythiasDicePlayer,
  naiadsaqueduct: NaiadsAqueductPlayer,
  panspanic: PansPanicPlayer,
  delphisdig: DelphisDigPlayer,
  midashoard: MidasHoardTvPlayer,
  chariots: ChariotsPlayer,
  scyllasstrait: ScyllasStraitPlayer,
};
