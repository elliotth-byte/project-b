...
// A per-player Favor of the Fates draw-status indicator for the host's voter
...
export function ChaosStatusBadge({ holderId, playerId, drawPicks }) {
  ...
  const title = isHolder ? "Won the Favor of the Fates" : hasPicked ? "Picked, but didn't win it" : "Hasn't made their Favor of the Fates pick yet";
  return (
    <span
      title={title}
      style={{
...
// A playing card face — used by the Favor of the Fates card-fan flavor moment.
