  ...
  return (
    <Card style={{ marginBottom: 20, textAlign: "center" }}>
      ...
      <p style={{ color: "#6b4f99", fontSize: 11, margin: "0 0 10px", fontStyle: "italic" }}>
        {hideReference
          ? 'Each arrow only shifts the alternating checkerboard squares woven into that row or column — wrapping around — to rebuild the weaving shown on the big screen. Tap "Check This" when you think you\'ve matched it.'
          : 'Each arrow only shifts the alternating checkerboard squares woven into that row or column — wrapping around — to rebuild the weaving shown on the right. Tap "Check This" when you think you\'ve matched it.'}
      </p>
