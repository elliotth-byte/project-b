...
// Used specifically for the battle winner's nomination timeout (see
// lib/roundEngine.js's autoNominateForWinnerIfTimedOut) — returns null
// if there's genuinely no eligible player left to pick (shouldn't happen
// in practice at any normal player count, but this is the honest answer
// rather than crashing or picking an invalid target).
