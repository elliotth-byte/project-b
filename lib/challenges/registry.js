...
export const GAME_REGISTRY = {
  ...
  basketball: { label: "Basketball", icon: "🏀", rank: "score-desc", defaultDurationSec: 180, config: { lives: 3 }, category: "Arcade", blurb: "The old Facebook mini-game — swipe up on the ball to shoot, 3 misses and you're done. Score enough baskets and the hoop starts moving: first sliding side to side, then roaming anywhere on the court. A clean swish is worth more than a rim-in or a bank shot off the backboard. Most points wins." },
  ...
  stockmarket: { label: "Stock Market", icon: "📈", rank: "score-desc", defaultDurationSec: 3600, category: "Finance", blurb: "$10,000 to trade real companies at real, live prices from Finnhub for the length of the battle — starts with 6 well-known stocks, but search adds any real US stock to the shared watchlist (up to 20 total). Highest final profit wins. Needs FINNHUB_API_KEY configured on the deployment (free at finnhub.io) — and only ever offered when the battle's own hours overlap real stock market trading hours." },
