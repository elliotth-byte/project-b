...
export function eligibleGameTypes(challengeHistory, disabledTypes = [], nowMs = null, durationSec = null) {
  ...
  const notDisabled2 = marketHoursOk ? notDisabled : notDisabled.filter((k) => k !== "stockmarket");
...
export function pickRandomChallenge(challengeHistory, disabledTypes = [], nowMs = null, durationSec = null) {
  const pool = eligibleGameTypes(challengeHistory, disabledTypes, nowMs, durationSec);
...
export function pickHephaestusOptions(challengeHistory, disabledTypes = [], nowMs = null, durationSec = null) {
  const pool = eligibleGameTypes(challengeHistory, disabledTypes, nowMs, durationSec);
