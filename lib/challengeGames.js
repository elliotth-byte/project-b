...
export const GAME_REGISTRY = {
  ...
  mazeinvisible: { label: "Invisible Maze", icon: "🕶️", rank: "time-asc", defaultDurationSec: 300, config: { size: 15 }, blurb: "Collect 3 gems in order. Toggle between viewing the maze (can't move) and moving blind (walls invisible, wall bumps cost time). Fastest wins." },
  ...
  slidingpuzzle: { label: "Sliding Puzzle", icon: "🧩", rank: "score-desc", defaultDurationSec: 240, blurb: "Classic 15-puzzle — slide tiles into the empty slot to get them back in order, 1 to 15. Same scramble for everyone, guaranteed solvable. Fastest solve wins; ran out of time ranks by how many tiles were placed correctly." },
  torched: { label: "Torched", icon: "🔥", rank: "score-desc", defaultDurationSec: 360, blurb: "Everyone secretly hides a 3-cell marker on one shared grid. Once placement's done, players take turns calling out coordinates — land on someone's marker and their whole thing goes up in flames, eliminating them on the spot. Last marker standing wins; everyone else is ranked by how long they survived." },
  chains: { label: "Chains", icon: "✊", rank: "score-desc", defaultDurationSec: 300, blurb: "Every player builds their own private order to face everyone else, picking rock, paper, or scissors against each — completely independent of what anyone else chooses or how they've ordered their own chain. Once everyone's locked in, chains play out: a win keeps yours going, a draw doesn't score but doesn't stop you either, a loss ends it right there. Highest score wins; ties go to whoever locked in first." },
  labyrinth: { label: "The Labyrinth", icon: "🐂", rank: "score-desc", defaultDurationSec: 240, config: { size: 13 }, blurb: "Navigate a maze collecting scattered olives while the Minotaur hunts you down — it recalculates the shortest path to wherever you actually are every single step, so there's no outrunning it by luck. Clear every olive before it catches you for the best possible finish; otherwise, whoever collected the most before getting caught (or before time runs out) ranks highest." },
  oraclesseal: { label: "The Oracle's Seal", icon: "🏺", rank: "score-desc", defaultDurationSec: 180, blurb: "Trace a shape stamped into a fragile clay tablet, from start back around to start — stray off the outline or lift your finger before you're done and it cracks. Too many cracks and the whole tablet shatters. Finish clean and it's a race against the clock; shatter first and you're ranked by how much of the outline you completed." },
};
