...
export const GAME_REGISTRY = {
  ...
  simmotion: { label: "Simmotion", icon: "🥎", rank: "score-desc", defaultDurationSec: 300, blurb: "Catch each ball on the side it's about to exit and it goes right back in — miss one and you're out. More balls join over time, up to 4 at once. Most catches before dropping wins." },
};
