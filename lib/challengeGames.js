...
export const GAME_REGISTRY = {
  ...
  pit: { label: "Mount Olympus Pit", icon: "🏺", rank: "score-desc", defaultDurationSec: 480, blurb: "Blind-trade cards of godly item sets with everyone else — offer 1-4 at a time, swap the instant someone offers the same count. First 3 to hold all 9 of one set win." },
};
