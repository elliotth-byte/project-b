...
export const GAME_REGISTRY = {
  ...
  dealornodeal: { label: "Deal or No Deal", icon: "💼", rank: "score-desc", defaultDurationSec: 300, category: "Luck", blurb: "Pick a case, open others for banker offers, and decide when to walk away. Highest dollar amount wins." },
  ...
  stroop: { label: "Stroop Wall", icon: "🌈", rank: "score-desc", defaultDurationSec: 240, category: "Visual", blurb: "20 color-name words, each printed in a mismatched ink color — tap the ink color, not the word. Same wall for everyone. Clear it fastest wins; a wrong answer costs time." },
