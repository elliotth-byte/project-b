...
Everyone votes for which nominee to save. The nominee with the fewest save-votes is eliminated — and if the Power of Khaos holder protects a different nominee that round, that protected nominee's votes are wiped to zero, guaranteeing THEY'RE also eliminated. Two people go home instead of one.`,
  ...
  {
    title: "🏆 The Finale",
    body: `Once the game's down to its final few, the Battle phase stops and the Finale begins. Finalists can write a statement, and the jury — every exiled player who didn't quit or get removed — can ask questions, which finalists can respond to.

Once that's done, the jury votes for a winner. The Power of Khaos is up for grabs among the jury too — the holder can wipe one finalist's votes entirely, guaranteeing they finish no better than 3rd regardless of how they actually polled.`,
  },
  {
    title: "🎥 Confessionals",
