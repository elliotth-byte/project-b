...
// Picked for genuinely different SETTINGS — commerce, combat, medicine,
// prophecy, celebration, danger, the divine, death, education, craft,
// crime, agriculture, sport, piracy, war, travel, nature, governance,
// performance, survival, leisure — rather than variations on "another
// god's temple." Theming (the Greek flavor) took a back seat to that
// diversity on purpose: a location list where every entry feels like
// the same kind of place makes for weak, sample-y questions no matter
// how it's dressed up.
export const SPYFALL_LOCATIONS = [
  "The Agora Marketplace", "A Trireme at Sea", "The Gladiator Training School",
  "Asclepius' Healing Temple", "The Oracle's Cave at Delphi", "A Royal Wedding Feast",
  "The Labyrinth of the Minotaur", "Mount Olympus Throne Room", "The Ferry Across the Styx",
  "A Philosopher's Academy", "The Blacksmith's Forge", "A Prison Dungeon",
  "The Vineyard Harvest", "The Olympic Games Stadium", "A Pirate's Hidden Cove",
  "The Amazon War Camp", "A Desert Trade Caravan", "The Sirens' Rocky Shore",
  "A Shepherd's Mountain Pasture", "A Traveling Theater Troupe", "The Shipwreck Island",
