...
// Okabe-Ito colorblind-safe palette — distinguishable under all common
// forms of color vision deficiency (deuteranopia, protanopia,
// tritanopia), unlike the old red/green-heavy set this replaced.
export const WORD_COLORS = ["#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7"];
